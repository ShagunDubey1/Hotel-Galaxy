...
const EventCard = () => {
    return (
        <section className="  relative  w-full  flex  flex-col justify-center items-center max-w-[1140px] pt-24">
            ...
            <h2 className=" text-5xl font-medium capitalize text-center mx-4 md:mx-0">
                Meetings & Events
            </h2>
            <div className=" w-full flex flex-col justify-center md:grid md:grid-rows-3 md:grid-cols-4 h-[28rem] p-4 md:p-16 md:px-20 sm:px-4  mt-0 md:mt-8 relative">
